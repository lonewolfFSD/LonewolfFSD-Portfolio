...
>
  {avatarURL || auth.currentUser?.photoURL ? (
    ...
    <User className="w-5 h-5 cursor-custom-pointer" />
          ...
          <motion.button
            className={`px-6 hidden md:block hover:px-8 transition-all py-2 rounded-full font-semibold text-[15px] ${isDark ? "bg-white text-black hover:bg-gray-100" : "bg-black text-white hover:bg-gray-900"} flex items-center gap-2`}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
