...
const PurchaseHistory: React.FC = () => {
  ...
  const parseDate = (dateStr: string): Date => {
    try {
      // Try parsing common date formats (adjust based on your data)
      const formats = [
        "yyyy-MM-dd HH:mm:ss",
        "yyyy-MM-dd",
        "MM/dd/yyyy HH:mm:ss",
      ...
      // Fallback to raw Date constructor
      ...
      <div className="max-w-6xl mx-auto bg-white p-6 sm:p-12 border border-black h-screen">
        <div className="flex justify-between items-center mb-8">
          <h2
            ...
            className="text-3xl sm:text-4xl font-bold mt-6 md:mt-auto text-left"
          >
            Purchase History
          </h2>
        </div>
