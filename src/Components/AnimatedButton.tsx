...
const AnimatedButton: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <motion.button
        className="relative cursor-custom-pointer -mt-8 3xl:mt-0 z-10 flex whitespace-nowrap items-center justify-center space-x-2 bg-black text-white px-32 py-3 lg:py-3.5 3xl:py-4 rounded-full text-lg font-medium transition-all duration-300 group-hover:bg-transparent group-hover:backdrop-blur-md group-hover:text-black border border-2 border-black"
